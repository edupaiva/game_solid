...
class JogoForca:
    ...
    O jogo sorteia um nome de uma lista de participantes e permite ao jogador
    tentar adivinhar as letras dentro de um limite de tentativas.
    """

    def __init__(self) -> None:
        """
        Inicializa o jogo da forca com uma lista de nomes, sorteia um nome
        aleatório e define os atributos do jogo.
        """
    ...
    def jogar(self) -> None:
        """
        Método principal que executa o loop do jogo, permitindo que o usuário
        tente adivinhar a palavra até o fim das tentativas.
        """
